...
function createPhoneInput(defaultMetadata) {
  var PhoneInputDefault = import_react.default.forwardRef(function(_ref, ref) {
    var _ref$metadata = _ref.metadata, metadata2 = _ref$metadata === void 0 ? defaultMetadata : _ref$metadata, _ref$labels = _ref.labels, labels2 = _ref$labels === void 0 ? en_json_default : _ref$labels, rest = _objectWithoutProperties(_ref, _excluded);
    return import_react.default.createElement(PhoneInputWithCountry_default, _extends({}, rest, {
      ref,
      metadata: metadata2,
      labels: labels2
    }));
